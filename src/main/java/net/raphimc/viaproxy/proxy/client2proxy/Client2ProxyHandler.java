...
public class Client2ProxyHandler extends SimpleChannelInboundHandler<IPacket> {
    ...
    private void connect(final SocketAddress serverAddress, final VersionEnum serverVersion, final VersionEnum clientVersion, final IntendedState intendedState, final UserOptions userOptions, final String[] handshakeParts, final String customHostname) {
